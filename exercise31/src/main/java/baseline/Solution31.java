...
public class Solution31 {
    ...
    private static Solution31 app = new Solution31();
    public static void main(String[] args) {
        ...
        while(x < 1){
            age = app.getInfo("age:");
            heartrate = app.getInfo("resting pulse:");
            //check if the user input is valid.
            if(!(app.validInput(age) && app.validInput(heartrate))){
        ...
        int userAge = app.getAge(age);
        int userRHeartRate = app.getrHeartRate(heartrate);
        //Display the output by using a Display function, which calls a getHeartRate function.
        app.display(userAge, userRHeartRate);
    }
    ...
    private int getrHeartRate(String rest){
    ...
    // as integers.
    public double getheartRate(int age, int rest, int intensity) {
    ...
    private void display(int age, int rest){
