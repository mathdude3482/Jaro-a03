...
public class Calculate {
    ...
    public static double getMinimum(List<Double> numbers){
        //take in one parameter: the ArrayList of Doubles.
    ...
    public static double getMaximum(List<Double> newList){
        //take in one parameter: the ArrayList of Doubles.
    ...
    public static double getstDeviation(List<Double> newList, double average){
        //take in one parameter: the ArrayList of Doubles.
        ...
        double meanOfDiffs = sum / (newList.size());
